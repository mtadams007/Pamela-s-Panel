...
Grade.create(student_id: 1, cohort_id: 1, grade: 'C')
Grade.create(student_id: 2, cohort_id: 1, grade: 'A')
Grade.create(student_id: 3, cohort_id: 2, grade: 'C')
Grade.create(student_id: 4, cohort_id: 1, grade: 'D')
Grade.create(student_id: 5, cohort_id: 2, grade: 'E')
Grade.create(student_id: 6, cohort_id: 2, grade: 'E')
Grade.create(student_id: 7, cohort_id: 3, grade: 'B')
Grade.create(student_id: 8, cohort_id: 3, grade: 'A')
Grade.create(student_id: 9, cohort_id: 3, grade: 'A')
Grade.create(student_id: 10, cohort_id: 4, grade: 'B')
